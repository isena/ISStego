#
#  Be sure to run `pod spec lint ISStego.podspec' to ensure this is a
...
Steganography comes from the Greek word and means "covered or protected". Basically it is the practice of hiding important information within a unimportant object. For instance we can hide a message within some image.
  ...
  s.homepage     = "https://github.com/isena/ISStego"
  ...
  s.author             = { "Isaac Stevao Sena" => "isaac.sena@gmail.com" }
  # Or just: s.author    = "Isaac Stevao Sena"
  # s.authors            = { "Isaac Stevao Sena" => "isaac.sena@gmail.com" }
  s.social_media_url   = "https://twitter.com/isaacstevaosena"
  ...
  s.source       = { :git => "https://github.com/isena/ISStego.git", :tag => "0.0.1" }
